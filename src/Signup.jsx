...
const Signup = () => {
  ...
  return (
    ...
    <div className="p-inputgroup flex-1 my-2">
        ...
        <Password value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Enter Password" feedback={false}/>
    </div>
    <div className="p-inputgroup flex-1 my-2">
        <span className="p-inputgroup-addon"><i className="pi pi-lock"></i></span>
        <Password value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} placeholder="Confirm Password" feedback={false} />
    </div>
